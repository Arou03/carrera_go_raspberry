...
# Charger la vidéo
video_path = "videos/sample1.mp4"  # Remplace par le chemin de ta vidéo
...
while True:
    ...
    # Prétraitement de l'image : Lettrebox (avec padding)
    ...
    # Affichage de la vidéo avec détection
    if time_diff >= 1 / fps_video:
